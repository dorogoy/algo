...
- [Algo VPN](#algo-vpn)
  ...
  - [Configure the VPN Clients](#configure-the-vpn-clients)
    ...
    - [Windows](#windows)
    - [Linux WireGuard Clients](#linux-wireguard-clients)
    - [Linux strongSwan IPsec Clients (e.g., OpenWRT, Ubuntu Server, etc.)](#linux-strongswan-ipsec-clients-eg-openwrt-ubuntu-server-etc)
    - [Other Devices](#other-devices)
  - [Setup an SSH Tunnel](#setup-an-ssh-tunnel)
  - [SSH into Algo Server](#ssh-into-algo-server)
  - [Adding or Removing Users](#adding-or-removing-users)
  - [Additional Documentation](#additional-documentation)
    - [Setup Instructions for Specific Cloud Providers](#setup-instructions-for-specific-cloud-providers)
    - [Install and Deploy from Common Platforms](#install-and-deploy-from-common-platforms)
  ...
  - [Extra: integration with 1Password](#extra-integration-with-1password)
    - [Push your configuration to 1Password](#push-your-configuration-to-1password)
    - [Get your configuration from 1Password](#get-your-configuration-from-1password)
